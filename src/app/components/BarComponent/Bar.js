...
export default function Bar({ name = "skill", icon = 'react', level = 'base' }) {
  let porcent = null;
  ...
  return (
    <div className="w-full h-auto flex flex-col">
      ...
      <div className="flex align-middle">
        <p className="flex items-center pl-2 pr-2 text-lg">[ <span className="animate-spin p-2">/</span> ]</p>
        <Icono nameIcon={icon} />
        <div className="flex flex-auto items-center pr-2 pl-2 h-auto">
          <span>[</span>
          <div className="flex-auto bg-purple-400">
            <div className={styles.animation} style={{ width: porcentText, animationDuration: animationDuration }} id="bar">.</div>
          </div>
          <span>]</span>
