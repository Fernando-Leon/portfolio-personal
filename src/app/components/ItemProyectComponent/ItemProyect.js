...
export default function ItemProyect( {title = 'Proyecto', img = '/images/proyects/p2.png'} ) {
    return(
        <div className="w-full rounded-md overflow-hidden relative cursor-pointer">
            ...
            <Image src={img} width={0} height={0} layout="responsive" className="rounded-md"/>
        </div>
    )
};                                                                                                                                                                                                                                                                                                                                                                                                              